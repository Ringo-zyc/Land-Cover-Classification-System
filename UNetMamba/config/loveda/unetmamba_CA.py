...
weights_name = "unetmamba_CA"+str(image_size)+"-e"+str(max_epoch)
...
pretrained_ckpt_path = "model_weights/loveda/unetmamba_CA1024-e100/last.ckpt" # the path for the pretrained unetmamba weight
...
#  define the network
net = UNetMambaCA(pretrained=pretrained_ckpt_path,
...
# from unetmamba_model.losses import *
# from unetmamba_model.datasets.loveda_dataset import *
# from unetmamba_model.models.UNetMamba_CA import UNetMamba
# from catalyst.contrib.nn import Lookahead
# from catalyst import utils
# from fvcore.nn import flop_count, parameter_count
# import copy
